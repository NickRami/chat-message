    ...
    <div className="min-h-screen bg-auth-gradient flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="glass-card p-8 sm:p-10 w-full max-w-md animate-fade-in relative z-10">
        ...
        <div className="flex justify-center mb-6">
          <div className="w-16 h-16 bg-gradient-to-br from-brand-500 to-brand-700 rounded-2xl flex items-center justify-center shadow-lg shadow-brand-500/30 animate-float">
            <MessageCircle size={32} className="text-white" />
          </div>
        </div>

        <h2 className="text-2xl font-bold text-center text-white mb-1">Welcome back</h2>
        <p className="text-surface-400 text-center text-sm mb-8">Sign in to continue to your conversations</p>
        ...
        <div className="mt-8 pt-6 border-t border-white/[0.06] text-center">
          <Link to="/register" className="text-sm text-surface-400 hover:text-brand-400 transition-colors duration-200">
            Don't have an account? <span className="font-semibold text-brand-400">Sign Up</span>
          </Link>
        </div>
      </div>
    </div>
